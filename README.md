...
- Primera pantalla de sólo lectura disponible en `?pag=bandeja-mensual`, con cursor firmado para recorrer extractos mensuales y un lote de sombra real acotado en `global_temp`.
