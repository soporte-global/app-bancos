...
Próximo paso: acordar las decisiones funcionales que los datos no resuelven (transiciones, asociaciones múltiples, reversas y retención), completar configuración de permisos de Hub y validar con datos representativos el plan de consultas/índices antes de avanzar con contratos API y funcionalidad de negocio.
