...
final class PrevalidarConciliacionCheque
{
    private $preflight;

    public function __construct(PreflightConciliacionChequeRepository $preflight)
    {
    ...
    public function ejecutar(array $entrada)
    {
        ...
        return $this->preflight->evaluar((int) $movimientoId, $cuentaBancariaId, $inicioPeriodo);
    }
}
