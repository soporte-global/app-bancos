...
CREATE TABLE IF NOT EXISTS global_prod.bancos_configuracion (
    ...
    updated_by bigint,
    CONSTRAINT bancos_configuracion_created_by_fk FOREIGN KEY (created_by)
        REFERENCES global_prod.rrhh_login(id),
    CONSTRAINT bancos_configuracion_updated_by_fk FOREIGN KEY (updated_by)
        REFERENCES global_prod.rrhh_login(id)
);
...
CREATE TABLE IF NOT EXISTS global_prod.bancos_configuracion_cuenta (
    ...
    cuenta_bancaria_erp_id bigint NOT NULL,
    created_at timestamptz NOT NULL DEFAULT now(),
    created_by bigint,
    updated_at timestamptz NOT NULL DEFAULT now(),
    updated_by bigint,
    ...
    CONSTRAINT bancos_configuracion_cuenta_cuenta_bancaria_fk FOREIGN KEY (cuenta_bancaria_erp_id)
        REFERENCES public.cuenta_bancaria(id),
    CONSTRAINT bancos_configuracion_cuenta_created_by_fk FOREIGN KEY (created_by)
        REFERENCES global_prod.rrhh_login(id),
    CONSTRAINT bancos_configuracion_cuenta_updated_by_fk FOREIGN KEY (updated_by)
        REFERENCES global_prod.rrhh_login(id),
    CONSTRAINT bancos_configuracion_cuenta_uk UNIQUE (configuracion_id, cuenta_bancaria_erp_id)
);

CREATE TABLE IF NOT EXISTS global_prod.bancos_regla_clasificacion (
    id bigserial PRIMARY KEY,
    configuracion_id bigint NOT NULL,
    subtipo_valor_erp_id smallint NOT NULL,
    ...
    CONSTRAINT bancos_regla_clasificacion_configuracion_fk FOREIGN KEY (configuracion_id)
        REFERENCES global_prod.bancos_configuracion(id),
    CONSTRAINT bancos_regla_clasificacion_created_by_fk FOREIGN KEY (created_by)
        REFERENCES global_prod.rrhh_login(id),
    CONSTRAINT bancos_regla_clasificacion_updated_by_fk FOREIGN KEY (updated_by)
        REFERENCES global_prod.rrhh_login(id)
);

CREATE UNIQUE INDEX IF NOT EXISTS bancos_regla_clasificacion_uk
    ON global_prod.bancos_regla_clasificacion(configuracion_id, subtipo_valor_erp_id, sentido, COALESCE(codigo_extracto, ''));

CREATE TABLE IF NOT EXISTS global_prod.bancos_mapeo_cuenta_contable (
    id bigserial PRIMARY KEY,
    configuracion_id bigint NOT NULL,
    subtipo_valor_erp_id smallint NOT NULL,
    cuenta_erp_id bigint NOT NULL,
    ...
    CONSTRAINT bancos_mapeo_cuenta_contable_configuracion_fk FOREIGN KEY (configuracion_id)
        REFERENCES global_prod.bancos_configuracion(id),
    CONSTRAINT bancos_mapeo_cuenta_contable_cuenta_fk FOREIGN KEY (cuenta_erp_id)
        REFERENCES public.cuenta(id),
    CONSTRAINT bancos_mapeo_cuenta_contable_created_by_fk FOREIGN KEY (created_by)
        REFERENCES global_prod.rrhh_login(id),
    CONSTRAINT bancos_mapeo_cuenta_contable_updated_by_fk FOREIGN KEY (updated_by)
        REFERENCES global_prod.rrhh_login(id),
    CONSTRAINT bancos_mapeo_cuenta_contable_uk UNIQUE (configuracion_id, subtipo_valor_erp_id, cuenta_erp_id)
);
...
CREATE TABLE IF NOT EXISTS global_prod.bancos_regla_asignacion_usuario (
    ...
    CONSTRAINT bancos_regla_asignacion_usuario_usuario_fk FOREIGN KEY (usuario)
        REFERENCES global_prod.rrhh_login(id),
    CONSTRAINT bancos_regla_asignacion_usuario_created_by_fk FOREIGN KEY (created_by)
        REFERENCES global_prod.rrhh_login(id),
    CONSTRAINT bancos_regla_asignacion_usuario_updated_by_fk FOREIGN KEY (updated_by)
        REFERENCES global_prod.rrhh_login(id),
    CONSTRAINT bancos_regla_asignacion_usuario_uk UNIQUE (configuracion_id, subtipo_valor_erp_id, usuario)
);
...
CREATE TABLE IF NOT EXISTS global_prod.bancos_importacion_extracto (
    ...
    CONSTRAINT bancos_importacion_extracto_configuracion_fk FOREIGN KEY (configuracion_id)
        REFERENCES global_prod.bancos_configuracion(id),
    CONSTRAINT bancos_importacion_extracto_cuenta_bancaria_fk FOREIGN KEY (cuenta_bancaria_erp_id)
        REFERENCES public.cuenta_bancaria(id),
    CONSTRAINT bancos_importacion_importante_created_by_fk FOREIGN KEY (created_by)
        REFERENCES global_prod.rrhh_login(id),
    CONSTRAINT bancos_importacion_importante_updated_by_fk FOREIGN KEY (updated_by)
        REFERENCES global_prod.rrhh_login(id)
);

CREATE INDEX IF NOT EXISTS bancos_importacion_extracto_periodo_idx
    ON global_prod.bancos_importacion_extracto(cuenta_bancaria_erp_id, inicio_periodo);

CREATE UNIQUE INDEX IF NOT EXISTS bancos_importacion_extracto_uk
    ON global_prod.bancos_importacion_extracto(cuenta_bancaria_erp_id, inicio_periodo, COALESCE(hash_origen, ''), COALESCE(version_origen, ''));
...
CREATE TABLE IF NOT EXISTS global_prod.bancos_movimiento_extracto (
    ...
    CONSTRAINT bancos_movimiento_extracto_created_by_fk FOREIGN KEY (created_by)
        REFERENCES global_prod.rrhh_login(id),
    CONSTRAINT bancos_movimiento_extracto_updated_by_fk FOREIGN KEY (updated_by)
        REFERENCES global_prod.rrhh_login(id),
...
CREATE TABLE IF NOT EXISTS global_prod.bancos_borrador_asiento (
    id bigserial PRIMARY KEY,
    movimiento_id bigint NOT NULL,
    nodo_erp_id integer NOT NULL,
    fecha_contable date NOT NULL,
    estado_id smallint NOT NULL REFERENCES global_prod.bancos_estado(id),
    operacion_erp_id bigint,
    asiento_erp_id bigint,
    ...
    CONSTRAINT bancos_borrador_asiento_movimiento_fk FOREIGN KEY (movimiento_id)
        REFERENCES global_prod.bancos_movimiento_extracto(id),
    CONSTRAINT bancos_borrador_asiento_nodo_fk FOREIGN KEY (nodo_erp_id)
        REFERENCES public.nodo(id),
    CONSTRAINT bancos_borrador_asiento_operacion_erp_fk FOREIGN KEY (operacion_erp_id)
        REFERENCES public.operacion(id),
    CONSTRAINT bancos_borrador_asiento_asiento_erp_fk FOREIGN KEY (asiento_erp_id)
        REFERENCES public.asiento(id),
    CONSTRAINT bancos_borrador_asiento_created_by_fk FOREIGN KEY (created_by)
        REFERENCES global_prod.rrhh_login(id),
    CONSTRAINT bancos_borrador_asiento_updated_by_fk FOREIGN KEY (updated_by)
        REFERENCES global_prod.rrhh_login(id),
    CONSTRAINT bancos_borrador_asiento_idempotencia_uk UNIQUE (clave_idempotencia),
    CONSTRAINT bancos_borrador_asiento_created_by_chk CHECK (nodo_erp_id > 0)
);
...
CREATE TABLE IF NOT EXISTS global_prod.bancos_linea_borrador_asiento (
    ...
    CONSTRAINT bancos_linea_borrador_asiento_cuenta_fk FOREIGN KEY (cuenta_erp_id)
        REFERENCES public.cuenta(id),
...
CREATE TABLE IF NOT EXISTS global_prod.bancos_asociacion_movimiento (
    ...
    CONSTRAINT bancos_asociacion_movimiento_movimiento_fk FOREIGN KEY (movimiento_id)
        REFERENCES global_prod.bancos_movimiento_extracto(id),
    CONSTRAINT bancos_asociacion_movimiento_valor_fk FOREIGN KEY (valor_erp_id)
        REFERENCES public.valor(id),
    CONSTRAINT bancos_asociacion_movimiento_asiento_fk FOREIGN KEY (asiento_erp_id)
        REFERENCES public.asiento(id),
    CONSTRAINT bancos_asociacion_movimiento_borrador_fk FOREIGN KEY (borrador_asiento_id)
        REFERENCES global_prod.bancos_borrador_asiento(id),
    CONSTRAINT bancos_asociacion_movimiento_usuario_fk FOREIGN KEY (creado_por)
        REFERENCES global_prod.rrhh_login(id),
    CONSTRAINT bancos_asociacion_movimiento_unico_destino_chk CHECK (
        (CASE WHEN valor_erp_id IS NOT NULL THEN 1 ELSE 0 END)
      + (CASE WHEN asiento_erp_id IS NOT NULL THEN 1 ELSE 0 END)
...
CREATE UNIQUE INDEX IF NOT EXISTS bancos_asociacion_movimiento_valor_activo_uk
    ON global_prod.bancos_asociacion_movimiento(valor_erp_id)
    WHERE activo AND valor_erp_id IS NOT NULL;

CREATE UNIQUE INDEX IF NOT EXISTS bancos_asociacion_movimiento_asiento_activo_uk
    ON global_prod.bancos_asociacion_movimiento(asiento_erp_id)
    WHERE activo AND asiento_erp_id IS NOT NULL;
...
CREATE TABLE IF NOT EXISTS global_prod.bancos_reserva_recurso (
    ...
    CONSTRAINT bancos_reserva_recurso_movimiento_fk FOREIGN KEY (movimiento_id)
        REFERENCES global_prod.bancos_movimiento_extracto(id),
    CONSTRAINT bancos_reserva_recurso_valor_fk FOREIGN KEY (valor_erp_id)
        REFERENCES public.valor(id),
    CONSTRAINT bancos_reserva_recurso_asiento_fk FOREIGN KEY (asiento_erp_id)
        REFERENCES public.asiento(id),
...
CREATE UNIQUE INDEX IF NOT EXISTS bancos_reserva_recurso_valor_activo_uk
    ON global_prod.bancos_reserva_recurso(valor_erp_id)
    WHERE activo AND valor_erp_id IS NOT NULL;

CREATE UNIQUE INDEX IF NOT EXISTS bancos_reserva_recurso_asiento_activo_uk
    ON global_prod.bancos_reserva_recurso(asiento_erp_id)
    WHERE activo AND asiento_erp_id IS NOT NULL;
...
CREATE TABLE IF NOT EXISTS global_prod.bancos_conciliacion_cheque (
    ...
    valor_origen_erp_id bigint NOT NULL,
    operacion_erp_id bigint NOT NULL,
    valor_resultante_erp_id bigint NOT NULL,
    asiento_erp_id bigint,
    ...
    CONSTRAINT bancos_conciliacion_cheque_operador_fk FOREIGN KEY (operador_hub_id)
        REFERENCES global_prod.rrhh_login(id),
    CONSTRAINT bancos_conciliacion_cheque_valor_origen_fk FOREIGN KEY (valor_origen_erp_id)
        REFERENCES public.valor(id),
    CONSTRAINT bancos_conciliacion_cheque_operacion_fk FOREIGN KEY (operacion_erp_id)
        REFERENCES public.operacion(id),
    CONSTRAINT bancos_conciliacion_cheque_valor_resultante_fk FOREIGN KEY (valor_resultante_erp_id)
        REFERENCES public.valor(id),
    CONSTRAINT bancos_conciliacion_cheque_asiento_fk FOREIGN KEY (asiento_erp_id)
        REFERENCES public.asiento(id),
