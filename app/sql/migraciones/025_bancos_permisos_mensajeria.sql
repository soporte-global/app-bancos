...
VALUES
    (
        'Agregar mensajes a movimientos bancarios',
        current_timestamp, current_timestamp, NULL,
        12, 2, 1, 'movimiento-agregar-mensaje', 'message-square-plus',
        'global_prod', 'app_bancos:accion:movimiento-agregar-mensaje'
    ),
    (
        'Marcar mensajes bancarios como leídos',
        current_timestamp, current_timestamp, NULL,
        12, 2, 1, 'movimiento-marcar-mensajes-leidos', 'mail-check',
        'global_prod', 'app_bancos:accion:movimiento-marcar-mensajes-leidos'
    )
