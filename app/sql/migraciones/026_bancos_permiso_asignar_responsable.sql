...
VALUES (
    'Asignar responsable a movimiento bancario',
    current_timestamp, current_timestamp, NULL,
    12, 2, 1, 'movimiento-asignar-responsable', 'user-round-check',
    'global_prod', 'app_bancos:accion:movimiento-asignar-responsable'
)
