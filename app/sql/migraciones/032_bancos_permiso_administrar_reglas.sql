...
VALUES (
    'Crear, versionar y retirar reglas bancarias',
    current_timestamp, current_timestamp, NULL,
    12, 2, 1, 'configuracion-administrar-reglas', 'list-check',
    'global_prod', 'app_bancos:accion:configuracion-administrar-reglas'
)
