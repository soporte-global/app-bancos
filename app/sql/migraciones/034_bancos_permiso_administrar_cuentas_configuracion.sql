...
VALUES (
    'Vincular cuentas bancarias a configuraciones',
    current_timestamp, current_timestamp, NULL,
    12, 2, 1, 'configuracion-administrar-cuentas', 'link',
    'global_prod', 'app_bancos:accion:configuracion-administrar-cuentas'
)
