...
| `global_prod.bancos_asociacion_movimiento` | vínculo de un movimiento con valor ERP, asiento existente o borrador | PK; FK a movimiento; `valor_erp_id bigint`, `asiento_erp_id bigint` o borrador, de manera exclusiva; monto `numeric(20,5)`; regla que impida destinos incompatibles |
