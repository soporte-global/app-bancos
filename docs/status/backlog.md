...
- Implementar la primera mutación funcional sobre la infraestructura común ya disponible; debe comenzar por una operación propia de preparación en `global_temp`, no por cierre ni por escritura ERP.
