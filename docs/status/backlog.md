...
- Crear fixtures versionados y mínimos en `global_temp` para la primera consulta de extractos; no insertar datos de prueba manualmente ni en esquemas productivos.
- Implementar la primera consulta paginada de extractos mediante `EsquemaBancos` y compararla en sombra con el legado.
