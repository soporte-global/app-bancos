...
- **Tarea 5 — Detalle visual de mensajes y borradores:** implementada y validada técnicamente el 2026-09-08. La fila conserva un resumen compacto y abre un panel lateral con asociación, mensajes, borradores e historial disponible, sin perder URL, cursor, scroll ni foco. La evidencia y el checklist están en [`docs/ux/evidence/task-5/`](evidence/task-5/README.md). Las correcciones transversales se revisarán al finalizar la secuencia, según indicación del usuario.
