...
En el detalle operativo, el resumen y las secciones alternan tonos suaves de la paleta; preparación y prevalidaciones usan el tono de atención y el borrador un matiz azul pizarra. Los indicadores positivos del detalle usan azul informativo en lugar de verde. Configuraciones diferencia visualmente cuentas vinculadas, mapeos y asignaciones con tintes informativo, pizarra y ámbar discretos. Las tablas del detalle y de Configuraciones comparten con la bandeja mensual la cabecera de alto contraste, filas alternadas y divisores horizontales. Los importes se muestran en formato argentino con exactamente dos decimales en bandeja, detalle, búsquedas e importación, sin reducir la precisión de los datos almacenados o enviados. Las etiquetas textuales y las confirmaciones siguen expresando el significado de cada estado o acción; el color sólo facilita el recorrido visual.
